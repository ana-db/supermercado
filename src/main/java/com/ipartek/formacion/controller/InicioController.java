...
public class InicioController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		try {
			...
			dao.create(new Producto(4, "Zumo de naranja", 2.75f, "https://supermercado.eroski.es/images/13899539.jpg", "Zumo de naranja exprimido sin pulpa ZÜ PREMIUM, brik 2 litros", 5));
			...
			dao.create(new Producto(8, "Queso", 11.40f, "https://supermercado.eroski.es/images/15962624.jpg", "Queso natural D.O. Idiazabal BAGA, cuña 550 g", 0));
